...
import { type ImageCardSection, type ImageCard } from "@/types/HomePage";
import RichText from "../ui/RichText";

const ImageCard = ({ hash_tag, header, cards }: ImageCardSection) => {
  return (
    <section
      id={hash_tag || ""}
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 place-items-center md:place-items-start gap-10 lg:gap-20">
