...
const ImageCard = ({ title, description, cards, variant }: any) => {
  return (
    <section className="py-[5.9375rem] flex flex-col justify-center gap-10 border-b border-[#007AB9] ">
      ...
      <div
        className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-20 ${
          variant === "SECONDARY" && "h-40 flex items-center"
        }`}
      >
        {/* eslint-disable-next-line @typescript-eslint/no-explicit-any */}
        {cards.map((card: any) => (
